      ...
      >
        ...
        >
          ...
          <tbody>
            ...
            <tr>
              <th scope="row">Function Type</th>
              <td>{data.Function_Type == "" ? "-" : data.Function_Type}</td>
            </tr>
            <tr>
              <th scope="row">Other Features</th>
              <td>{data.Other_Features == "" ? "-" : data.Other_Features}</td>
            </tr>
            <tr>
              <th scope="row">Speed</th>
              <td>{data.Speed == "" ? "-" : data.Speed}</td>
            </tr>
            <tr>
              <th scope="row">Washing Capacity</th>
              <td>
                {data.Washing_Capacity == "" ? "-" : data.Washing_Capacity}
              </td>
            </tr>
            <tr>
              <th scope="row">Star</th>
              <td>{data.Star == "" ? "-" : data.Star}</td>
            </tr>
            <tr>
              <th scope="row">Warranty</th>
              <td>{data.Warranty == "" ? "-" : data.Warranty}</td>
