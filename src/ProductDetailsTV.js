        ...
        >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{data.Display_Size == "" ? "-" : data.Display_Size}</td>
            </tr>
            <tr>
              <th scope="row">Screen Type</th>
              <td>{data.Screen_Type == "" ? "-" : data.Screen_Type}</td>
            </tr>
            <tr>
              <th scope="row">HDMI</th>
              <td>{data.HDMI == "" ? "-" : data.HDMI}</td>
            </tr>
            <tr>
              <th scope="row">Processor</th>
              <td>{data.Processor == "" ? "-" : data.Processor}</td>
            ...
            <tr>
              <th scope="row">Clocking Speed</th>
              <td>{data.Clocking_Speed == "" ? "-" : data.Clocking_Speed}</td>
            </tr>
            <tr>
              <th scope="row">Storage Memory</th>
              <td>{data.Storage_Memory == "" ? "-" : data.Storage_Memory}</td>
            </tr>
            <tr>
              <th scope="row">Ram Capacity</th>
              <td>{data.Ram_Capacity == "" ? "-" : data.Ram_Capacity}</td>
            </tr>
            <tr>
              <th scope="row">Graphic Processor</th>
              <td>
                {data.Graphic_Processor == "" ? "-" : data.Graphic_Processor}
              </td>
            </tr>
            <tr>
              <th scope="row">Warranty</th>
