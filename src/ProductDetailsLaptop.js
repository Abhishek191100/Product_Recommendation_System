        ...
        >
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>{data.Series == "" ? "-" : data.Series}</td>
            </tr>
            <tr>
              <th scope="row">OS</th>
              <td>
                {data.Operating_System == "" ? "-" : data.Operating_System}
              </td>
            </tr>
            <tr>
              <th scope="row">Highlights</th>
            ...
            <tr>
              ...
              <td>{data.Screen_Size == "" ? "-" : data.Screen_Size}</td>
            </tr>
            <tr>
              <th scope="row">Resolution</th>
              <td>{data.Resolution == "" ? "-" : data.Resolution}</td>
            </tr>
            <tr>
              <th scope="row">Color</th>
              <td>{data.Color == "" ? "-" : data.Color}</td>
            ...
            <tr>
              <th scope="row">Processor</th>
              <td>{data.Processor_Name == "" ? "-" : data.Processor_Name}</td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td>{data.RAM_Type == "" ? "-" : data.RAM_Type}</td>
            </tr>
            <tr>
              <th scope="row">Weight</th>
              <td>{data.Weight == "" ? "-" : data.Weight}</td>
