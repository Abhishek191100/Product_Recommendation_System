...
import "./components/instantfood.css";
...
const InstantFood = () => {
  ...
  window.sessionStorage.setItem("bachat_category", "instantfood");
  ...
  const submitSearchFirst = () => {
    ...
    if (searchfirst) {
      ...
      /*change*/
      window.location = `/search/instantfood/product`;
    }
  };
  ...
  const deviceLogoY = (
    <>
      ...
      >
        ...
        <h4 className="mobiletag">Food</h4>
      </div>
