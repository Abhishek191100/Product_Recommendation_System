...
const Laptop = () => {
  ...
  window.sessionStorage.setItem("bachat_category", "laptop");
  ...
  const submitSearchFirst = () => {
    ...
    if (searchfirst) {
      ...
      window.location = `/search/laptop/product`;
    }
  };
    ...
    const deviceLogoY = (
      <>
        ...
        >
          ...
          >
            {/* change */}
            <LaptopIcon className="deviceiconsp" style={{ fontSize: "8.25rem", color: "#000" }} />
          </div>
          <h4 className="mobiletag" style={{marginRight:"121px"}}>Laptop</h4>
        </div>
  ...
  return (
    <div className="mobile" style={{ height: "650px", background: "white" }}>
      ...
      <LaptopIcon style={{fontSize:"6rem",width: "100%"}} className="mobileImg" />
      </div>
